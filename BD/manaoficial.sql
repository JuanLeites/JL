...
CREATE TABLE Proveedor ( ID_PROVEEDOR INT AUTO_INCREMENT PRIMARY KEY, Contacto VARCHAR(255), Razón_Social VARCHAR(255), RUT VARCHAR(20), Activo BOOLEAN);
