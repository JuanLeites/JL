...
<body>
    <div class="compra-venta">
        ...
        <div class="formularios">
            ...
            <?php
            if($datosdeventa["RUT"]!=""){
                echo '<p>RUT : '.$datosdeventa["RUT"].'</p>';
            }?>
            <p>Fecha de la Venta : <?php echo $datosdeventa["Fecha_Venta"]; ?> </p>
            <p>El Cliente pagó : <?php echo number_format($datosdeventa["Monto"], 2, '.', ''); ?></p>
            <p>Generó una deuda de : <?php echo number_format(($datosdeventa["Precio_Final"] - $datosdeventa["Monto"]), 2, '.', ''); ?></p>
